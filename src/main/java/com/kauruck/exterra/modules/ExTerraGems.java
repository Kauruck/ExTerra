...
public class ExTerraGems {
    ...
    //Blocks for the gems
    public static final RegistryObject<Block> RUBY_BLOCK = ExTerraModules.BLOCKS.register("ruby_block", () -> new BlockBase(5,Material.IRON, RESOURCE_TAB, ToolType.PICKAXE, 2));
    ...
    public static final RegistryObject<Block> SAPPHIRE_BLOCK = ExTerraModules.BLOCKS.register("sapphire_block", () -> new BlockBase(5, Material.IRON, RESOURCE_TAB, ToolType.PICKAXE, 2));
    ...
    //Ores for the gems
    public static final RegistryObject<Block> RUBY_ORE = ExTerraModules.BLOCKS.register("ruby_ore", () -> new BlockBase(3, Material.IRON, RESOURCE_TAB, ToolType.PICKAXE, 2));
    ...
    public static final RegistryObject<Block> SAPPHIRE_ORE = ExTerraModules.BLOCKS.register("sapphire_ore", () -> new BlockBase(3, Material.IRON, RESOURCE_TAB, ToolType.PICKAXE, 2));
