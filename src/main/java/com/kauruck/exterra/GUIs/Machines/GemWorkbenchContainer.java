...
import com.kauruck.exterra.Init.ModContainers;
...
public class GemWorkbenchContainer extends Container {
    ...
    public GemWorkbenchContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.GEM_WORKBENCH, windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, ModBlocks.GEM_WORKBENCH);
    }
